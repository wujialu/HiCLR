...
expansion_policy=hiclr
# target_smiles=paroutes_n1_random_100
target_smiles=caspyrus_random_100
nproc=8
gpu_ids='0 1 2 3 4 5 6 7'

for target_smiles in paroutes_n1_random_100
do
    mkdir ./experiments/output/${expansion_policy}_44000/${target_smiles}
    python ./aizynthfinder/interfaces/aizynthcli.py \
        ...
        --output ./experiments/output/${expansion_policy}_44000/${target_smiles}/output.hdf5 \
        --nproc ${nproc} \
        --gpu_ids ${gpu_ids}
done